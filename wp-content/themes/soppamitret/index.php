		...
		<div class="row">
			<div class="col-md-12">
				<div class="block text-center">
					<span class="text-white">Soppamitret Blogs</span>
					<h1 class="text-capitalize mb-5 text-lg">Discover the Benefits of Natural Remedies and Traditional Healing Practices.</h1>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					<h2>Soppamitret Blogs</h2>
					<div class="divider mx-auto my-4"></div>
					<p>Learn Holistic Healing and Exploring Alternative Medicine Therapies by our blog<</p>
				</div>
			</div>
		</div>
