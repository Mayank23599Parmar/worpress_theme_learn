		...
		<div class="row">
			<div class="col-md-12">
				<div class="block text-center">
					<span class="text-white">Soppamitret Therapies</span>
					<h1 class="text-capitalize mb-5 text-lg">Discover a better you through therapy by our therapies.</h1>
				</div>
			</div>
		</div>
	</div>
