    ...
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="contact-block mb-4 mb-lg-0">
          ...
          <h5>Call Us</h5>
          <a href="tel:<?php genralSettings("mobileNumber")?>"><?php genralSettings("mobileNumber")?></a>
        </div>
      </div>
      <div class="col-lg-4 col-md-6">
        <div class="contact-block mb-4 mb-lg-0">
          ...
          <h5>Email Us</h5>
          <a href="mailto:support@email.com"><?php genralSettings("email")?></a>
        </div>
      </div>
